#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Funkcja do sprawdzania istnienia programów - check_programs w pliku start.sh

#romek@DESKTOP-ROMEK:~/mc$ command -v tree 
#/usr/bin/tree

#Ścieżki zdefiniowane
...
# Lokalizacja Inxi (sprawdź poprawną ścieżkę do interpretera inxia na swoim systemie)
INXI_PATH="/usr/bin/inxi"

# Lokalizacja Unzip (sprawdź poprawną ścieżkę do interpretera unzipa na swoim systemie)
UNZIP_PATH="/usr/bin/unzip"
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#ścieżki nie zdefiniowane
