...
AUTO_UPDATE=false   #true lub false

# Automatyczne połączenie do konsoli serwera minecraft przy użyciu parametru - start
AUTO_CONNECT=true   #true lub false
...
SERVER_JAR="$SERVER_DIR/paper-1.20.2-249.jar"
